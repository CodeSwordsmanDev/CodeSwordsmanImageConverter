...
| :------------: | :----------------: |
| ![Main Interface](assets/en/1.png) | ![Platform Selection](assets/en/2.png) |

| Format Selection | Result Preview |
| :--------------: | :------------: |
| ![Format Selection](assets/en/3.png) | ![Result Preview](assets/en/4.png) |

| Output Settings |
| :-------------: |
| ![Output Settings](assets/en/5.png) |

#### 中文界面

| 主界面 | 格式选择 |
| :---: | :---: |
| ![主界面](assets/zh/1.png) | ![格式选择](assets/zh/2.png) |

| 结果预览 | 平台选择 |
| :---: | :---: |
| ![结果预览](assets/zh/3.png) | ![平台选择](assets/zh/4.png) |

| 输出设置 |
| :---: |
| ![输出设置](assets/zh/5.png) |
...
| Linux | 16×16, 24×24, 32×32, 48×48, 64×64, 96×96, 128×128, 256×256, 512×512 | PNG |
...
2. Select target platform (Windows/macOS/Android/iOS/Web/Linux)
3. Add images by clicking "Select Image" or dragging images to the window
4. Configure output settings (format, size, naming rules, etc.)
5. Click "Generate Icon" to start conversion
6. Files are automatically saved to the target directory

### 中文版

1. 下载并打开软件
2. 选择目标平台（Windows/macOS/Android/iOS/Web/Linux）
3. 点击"选择图片"或拖拽图片到窗口
4. 配置输出设置（格式、尺寸、命名规则等）
5. 点击"生成图标"开始转换
6. 自动保存到目标目录
